...
Report bugs at https://github.com/5h4d0wb0y/cookiecutter-flutter/issues
...
https://github.com/5h4d0wb0y/cookiecutter-flutter/issues.
...
Ready to contribute? Here's how to set up `cookiecutter-flutter` for local
development. Please note this documentation assumes you already have
`virtualenv` and `Git` installed and ready to go.

1. Fork the `cookiecutter-flutter` repo on GitHub.
...
2. Clone your fork locally:
   ...
   .. code-block:: bash
    ...
    $ git clone git@github.com:YOUR_NAME/cookiecutter-flutter.git
...
3. Assuming you have virtualenv installed (If you have Python 3.6 this should
   ...
   .. code-block:: bash
        ...
        $ virtualenv cookiecutter-flutter-env
        $ source cookiecutter-flutter-env/bin/activate

   This should change the shell to look something like:

   .. code-block:: bash

        (cookiecutter-flutter-env) $
...
6. The next step would be to run the test cases. `cookiecutter-flutter` uses
...
3. The pull request should work for Python 3.6 and 3.7, 3.8 and for PyPy. Check
   https://travis-ci.org/5h4d0wb0y/cookiecutter-flutter/pull_requests and
...
.. cookiecutter: https://github.com/5h4d0wb0y/cookiecutter-flutter
